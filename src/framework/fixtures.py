...
def mock_glue_context(spark_context):
    ...
    gc.create_sample_dynamic_frame_from_catalog = Mock('create_sample_dynamic_frame_from_catalog')
    gc.create_sample_dynamic_frame_from_options = Mock('create_sample_dynamic_frame_from_options')
